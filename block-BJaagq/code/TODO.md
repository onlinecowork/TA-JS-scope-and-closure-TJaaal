...
- Create the execution context diagram
- What will be the value of 1, 2, 3, 4 and 5 or error if the code does not work // four is not defined is the error message that will show, so the rest of the code cannot execute.
